...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn_9, btn_8, btn_7, btn_6, btn_5, btn_4, btn_3, btn_2, btn_1, btn_0,
            btn_porcentajes, btn_sum, btn_rest, btn_mult, btn_div,  btn_igual,
            btn_punto, btn_parentesis, btn_c, btn_del;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_punto= (Button) findViewById(R.id.btn_puntos);
        btn_parentesis= (Button) findViewById(R.id.btn_parentesis);
        btn_porcentajes= (Button) findViewById(R.id.btn_porcentajes);
    ...
    public void calcular(View view){
        ...
        //Validacion para no repetir punto
        ...
        btn_porcentajes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                data=tv_operacion.getText().toString();
                tv_operacion.setText(data+"%");
